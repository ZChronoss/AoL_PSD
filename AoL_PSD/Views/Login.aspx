<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="AoL_PSD.Views.Login" %>
    ...
    <form id="form1" runat="server">
        ...
        <div style="display:flex; flex-direction:column; align-items: center; justify-content: center; gap:10px;">
            <div class="username">
                ...
                <asp:Label ID="UsernameEmpty" runat="server" Visible="false" style="color:red;" Text="Username must be filled!" ></asp:Label>
            </div>
            <div class="password">
                <asp:TextBox ID="PasswordTextBox" runat="server" TextMode="Password" placeholder="Password"></asp:TextBox><br/>
                <asp:Label ID="PasswordEmpty" runat="server" Visible="false" style="color:red;" Text="Password must be filled!" ></asp:Label>
            </div>
